...
def container_class_from_list(
    varlist: list, class_name="myclass", save_dir=None, usetabs=False, num_spaces=4
):
    res_list = []
    pipeline = [init_from_list, selfdot_from_list, todict_from_list, fromdict_from_list]
    for p in pipeline:
    ...
    if save_dir is not None:
        outpath = f"{save_dir}/{class_name}.py"
